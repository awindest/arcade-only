<script lang="ts">
	...
	import arcade_machine_own from '$components/arcade_machine_own.svelte'
...
>
	...
	{#if game.orbitControls}
		<T.PerspectiveCamera position.x={20} position.y={20} position.z={20} fov={60} makeDefault>
			<OrbitControls />
		</T.PerspectiveCamera>
	{:else}
		<T.PerspectiveCamera
